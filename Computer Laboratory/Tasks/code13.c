...
int main(int argc, char* argv[]){
  ...
  for(int i = 0; i<infoimg.linhas; i++){
    for(int j = 0; j<infoimg.colunas; j++){
      fprintf(argc == 3 ? img : stdout, "%d ", infoimg.matriz[infoimg.linhas-1-i][j].r);
      fprintf(argc == 3 ? img : stdout, "%d ", infoimg.matriz[infoimg.linhas-1-i][j].g);
      fprintf(argc == 3 ? img : stdout, "%d", infoimg.matriz[infoimg.linhas-1-i][j].b);
