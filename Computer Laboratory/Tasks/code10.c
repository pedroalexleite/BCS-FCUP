...
int main(int argc, char* argv[]){
  ...
  for(int i = 0; i<infoimg.colunas; i++){
    for(int j = 0; j<infoimg.linhas; j++){
      fprintf(argc == 3 ? img : stdout, "%d ", infoimg.matriz[infoimg.linhas-1-j][i].r);
      fprintf(argc == 3 ? img : stdout, "%d ", infoimg.matriz[infoimg.linhas-1-j][i].g);
      fprintf(argc == 3 ? img : stdout, "%d", infoimg.matriz[infoimg.linhas-1-j][i].b);
