...
int main(int argc, char* argv[]){
  ...
  fprintf(argc == 3 ? img : stdout, "%d %d\n", infoimg.linhas, infoimg.colunas);
  fprintf(argc == 3 ? img : stdout, "%d\n", infoimg.max);
  for(int i = 0; i<infoimg.colunas; i++){
    for(int j = 0; j<infoimg.linhas; j++){
      fprintf(argc == 3 ? img : stdout, "%d ", infoimg.matriz[j][infoimg.colunas-1-i].r);
      fprintf(argc == 3 ? img : stdout, "%d ", infoimg.matriz[j][infoimg.colunas-1-i].g);
      fprintf(argc == 3 ? img : stdout, "%d", infoimg.matriz[j][infoimg.colunas-1-i].b);
